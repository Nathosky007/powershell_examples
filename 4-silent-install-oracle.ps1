...
Function OracleComponentInstall
{
    ...
    Start-Process -FilePath "C:\installs\Utilities\ODAC1110720\setup.exe" -ArgumentList "-noConsole -silent -debug -force -nowait FROM_LOCATION=C:\installs\Utilities\ODAC1110720\stage\custom_installation_landata.xml ORACLE_HOME=H:\Oracle\product\11.1.0\client_1 ORACLE_HOME_NAME=OracleClient_11Home ORACLE_BASE=H:\Oracle"
