# $Server = "ftp://ec2-54-66-212-164.ap-southeast-2.compute.amazonaws.com"

$Server = "ftp://54.66.212.164"
$User = "Admin01"
$Pass = "K2qwert"

#$Directory='/home/ftp_user/DATA/FTPROOT/Dataexch/int/LVGIS/SMES/adjustments/Campaign'
...
Get-FtpDirectory('/home/ftp_user/DATA/FTPROOT/Dataexch/int/LVGIS/SMES/adjustments/Campaign')