<#Author: Sainath M
 Date: 17062018
 Name: 3-add-hosts-windows.ps1
 Source: https://stackoverflow.com/questions/2602460/powershell-to-manipulate-host-file/42843058
 Credits: https://stackoverflow.com/users/4790186/jason
#>
